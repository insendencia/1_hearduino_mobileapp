...
public class Activity_AboutPage extends AppCompatActivity {
    ...
    private void showDialog(){
        ...
        home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(Activity_AboutPage.this, Activity_UserHome.class);
                startActivity(i);
            }
        });
        ...
        cameraFootage.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(Activity_AboutPage.this, Activity_CameraFootage.class);
                startActivity(i);
            }
        });
        ...
        doorbellHistory.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(Activity_AboutPage.this, Activity_DoorbellHistory.class);
                startActivity(i);
            }
        });
        ...
        listRegisterVisitor.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent j = new Intent(Activity_AboutPage.this, Activity_ListOfRegisteredVisitors.class);
                startActivity(j);
            }
        });
        ...
        about.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(Activity_AboutPage.this, Activity_AboutPage.class);
                startActivity(i);
            }
        });

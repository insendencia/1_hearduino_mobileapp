...
public class Activity_ListOfRegisteredVisitors extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_listofregisteredvisitors);
    ...
    private void showDialog(){
        ...
        home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(Activity_ListOfRegisteredVisitors.this, Activity_UserHome.class);
                startActivity(i);
            }
        });
        ...
        cameraFootage.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(Activity_ListOfRegisteredVisitors.this, Activity_CameraFootage.class);
                startActivity(i);
            }
        });
        ...
        doorbellHistory.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(Activity_ListOfRegisteredVisitors.this, Activity_DoorbellHistory.class);
                startActivity(i);
            }
        });
        ...
        listRegisterVisitor.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent j = new Intent(Activity_ListOfRegisteredVisitors.this, Activity_ListOfRegisteredVisitors.class);
                startActivity(j);
            }
        });
        ...
        about.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(Activity_ListOfRegisteredVisitors.this, Activity_AboutPage.class);
                startActivity(i);
            }
        });

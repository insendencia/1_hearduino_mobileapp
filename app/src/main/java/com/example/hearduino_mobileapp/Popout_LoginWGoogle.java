...
public class Popout_LoginWGoogle extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.popout_loginwgoogle);
    ...
    void navigateToSecondActivity(){
        finish();
        Intent i = new Intent(Popout_LoginWGoogle.this, Popout_SignUpWGoogle.class);
        startActivity(i);
